...
void Serial_init(){
    ...
    DHT11_dma_init.DMA_BufferSize = 10;
    ...
    DHT11_dma_init.DMA_Priority = DMA_Priority_High;
    DMA_Init(DMA1_Channel4, &DHT11_dma_init);

    // NVIC_InitTypeDef Serial_TD_init;
    // Serial_TD_init.NVIC_IRQChannel = DMA1_Channel4_IRQn;
    // Serial_TD_init.NVIC_IRQChannelCmd = ENABLE;
    // Serial_TD_init.NVIC_IRQChannelPreemptionPriority = 1;
    // Serial_TD_init.NVIC_IRQChannelSubPriority = 1;
    // NVIC_Init(&Serial_TD_init);
